    ...
    <div class="col-lg-8">
        ...
        <div class="stat-card p-0 overflow-hidden">
            <div class="bg-light p-3 border-bottom d-flex justify-content-between align-items-center">
                ...
                <a href="<?php echo e(route('download.file', ['path' => $surat->file])); ?>" class="btn btn-sm btn-outline-primary rounded-pill"><i class="bi bi-download me-1"></i> Unduh File</a>
            </div>
            <div class="p-4 d-flex justify-content-center bg-dark bg-opacity-10">
                <div class="bg-white border shadow-sm p-5 text-center" style="width: 100%; max-width: 600px; min-height: 500px;">
                    ...
                    <iframe src="https://docs.google.com/viewer?url=<?php echo e(urlencode(Storage::disk('s3')->url($surat->file))); ?>&embedded=true" width="100%" height="400px" style="border: none;">
