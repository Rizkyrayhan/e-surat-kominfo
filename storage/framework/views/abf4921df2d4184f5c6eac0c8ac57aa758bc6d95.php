    ...
    <div class="col-lg-8">
        <div class="card border-0 shadow-sm">
            <div class="card-body p-4">
                <form action="<?php echo e(route('admin.opd-accounts.store')); ?>" method="POST">
                    <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="nama_instansi" name="nama_instansi" value="<?php echo e(old('nama_instansi')); ?>" placeholder="Contoh: Dinas Kesehatan" required>
...
unset($__errorArgs, $__bag); ?>" id="name" name="name" value="<?php echo e(old('name')); ?>" placeholder="Contoh: Budi Santoso" required>
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="admin@dinkes.go.id" required>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\e-surat-kominfo\resources\views/admin/opd_accounts/create.blade.php ENDPATH**/ ?>