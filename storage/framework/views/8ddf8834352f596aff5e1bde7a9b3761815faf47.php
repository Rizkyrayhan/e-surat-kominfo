...
<div class="row mt-5 g-4">
    <div class="col-lg-8">
        ...
        <div class="row g-3">
            <?php $__empty_1 = true; $__currentLoopData = $recentSurats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $surat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <div class="col-md-6">
                <div class="stat-card p-4">
                    <div class="d-flex justify-content-between align-items-start mb-3">
                        ...
                        <?php elseif($surat->status == 'diproses' || $surat->status == 'dikirim'): ?>
                        ...
                        <?php endif; ?>
                        <span class="text-muted small"><?php echo e($surat->created_at->diffForHumans()); ?></span>
                    </div>
                    <h6 class="fw-bold text-primary-blue mb-2"><?php echo e($surat->nomor_surat); ?></h6>
                    <p class="text-muted small text-truncate mb-3"><?php echo e($surat->keterangan ?? 'Tidak ada keterangan'); ?></p>
                    <div class="d-flex align-items-center text-muted small border-top pt-3">
                        <i class="bi bi-person me-2"></i> Oleh: <?php echo e(Auth::user()->name); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\e-surat-kominfo\resources\views/opd/upload.blade.php ENDPATH**/ ?>