...
<div class="mb-4">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb text-uppercase small fw-semibold">
            <li class="breadcrumb-item"><a href="<?php echo e(route('opd.surat-masuk.index')); ?>" class="text-muted text-decoration-none">SURAT MASUK</a></li>
        ...
        <div class="stat-card p-4 p-lg-5 h-100">
            ...
            <div class="row g-4">
                <div class="col-md-6">
                    ...
                    <p class="fw-bold text-dark fs-5"><?php echo e($surat->nomor_surat); ?></p>
                </div>
                <div class="col-md-6">
                    <label class="text-muted small text-uppercase fw-bold mb-1">Tanggal Surat</label>
                    <p class="fw-bold text-dark fs-5"><?php echo e($surat->tanggal->format('d F Y')); ?></p>
                </div>
                <div class="col-md-12">
                ...
                <div class="col-md-6">
                    ...
                    <div class="d-flex align-items-center">
                        <img src="https://ui-avatars.com/api/?name=<?php echo e(urlencode($surat->pengirim->name)); ?>&background=EBF4FF&color=1E3A8A" alt="Admin" class="rounded-circle me-2" width="32" height="32">
                        <span class="text-dark fw-bold"><?php echo e($surat->pengirim->name); ?></span>
                    </div>
                </div>
                <div class="col-md-6">
                    <label class="text-muted small text-uppercase fw-bold mb-1">Diterima Pada</label>
                    <p class="text-dark"><?php echo e($surat->created_at->format('d M Y, H:i')); ?> WIB</p>
                </div>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\e-surat-kominfo\resources\views/opd/surat-masuk/show.blade.php ENDPATH**/ ?>