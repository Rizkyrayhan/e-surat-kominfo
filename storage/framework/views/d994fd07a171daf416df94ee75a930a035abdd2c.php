                ...
                <tr id="surat-row-<?php echo e($surat->id); ?>">
                    ...
                    <td class="pe-4 text-end">
                        <div class="d-flex justify-content-end gap-2">
                            ...
                            <a href="<?php echo e(route('download.file', ['path' => $surat->file])); ?>" class="btn btn-sm btn-light text-muted rounded-circle" title="Download PDF"><i class="bi bi-download"></i></a>
                        </div>
                    </td>
                </tr>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\e-surat-kominfo\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>