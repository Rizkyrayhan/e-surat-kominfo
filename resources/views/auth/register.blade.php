                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control border-start-0 ps-0 @error('name') is-invalid @enderror" id="name" name="name" value="{{ old('name') }}" placeholder="Contoh: Budi Santoso" required autofocus>
                        </div>
                        @error('name')
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <select class="form-select border-start-0 ps-0 @error('role') is-invalid @enderror" id="role" name="role" required>
                                <option value="opd" {{ old('role') == 'opd' ? 'selected' : '' }}>OPD (Organisasi Perangkat Daerah)</option>
                                <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Admin Kominfo</option>
                            </select>
                        </div>
                        @error('role')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                    ...
                    <div class="mb-3">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="nama@instansi.go.id" required>
                        </div>
                        @error('email')
                            <div class="text-danger small mt-1">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="row mb-4">
                        <div class="col-md-6 mb-3 mb-md-0">
                            ...
                            <div class="input-group">
                                ...
                                <input type="password" class="form-control border-start-0 ps-0 @error('password') is-invalid @enderror" id="password" name="password" placeholder="••••••••" required>
                            </div>
                            @error('password')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="text-center mt-3">
                        <p class="text-muted small mb-0">Sudah memiliki akun? <a href="{{ route('login') }}" class="text-primary text-decoration-none fw-bold" style="color: #0A256B !important;">Masuk Sekarang</a></p>
                    </div>
                </form>
