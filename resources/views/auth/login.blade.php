                ...
                <form method="POST" action="{{ route('login') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="email" class="form-control border-start-0 ps-0 @error('email') is-invalid @enderror" id="email" name="email" value="{{ old('email') }}" placeholder="nama.pegawai@kominfo.go.id" required autofocus>
                        </div>
                        @error('email')
                    ...
                    <div class="mb-4">
                        ...
                        <div class="input-group">
                            ...
                            <input type="password" class="form-control border-start-0 border-end-0 ps-0 @error('password') is-invalid @enderror" id="password" name="password" placeholder="••••••••••••" required>
                    ...
                    <div class="text-center mt-4">
                        ...
                        <a href="{{ route('register') }}" class="btn btn-outline-primary rounded-pill px-4 py-2 text-decoration-none small d-inline-flex align-items-center gap-2">
