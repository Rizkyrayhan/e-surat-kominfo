    ...
    <div class="container-fluid px-4 px-lg-5">
        ...
        <div class="collapse navbar-collapse" id="landingNavbar">
            ...
            <div class="d-flex align-items-center gap-3 mt-3 mt-lg-0">
                @auth
                    <a href="{{ Auth::user()->role === 'admin' ? route('admin.dashboard') : route('opd.dashboard') }}" class="text-decoration-none text-dark-blue fw-medium px-2" style="font-size: 0.9rem;">
                        Dashboard
                    </a>
                @else

                    <a href="{{ route('login') }}" class="btn btn-dark-blue rounded-3 px-4 fw-medium" style="font-size: 0.9rem;">
                        Masuk
                    </a>
                @endauth
            </div>
        ...
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 pe-lg-5">
                ...
                <div class="d-flex flex-wrap gap-3">
                    @auth
                        <a href="{{ Auth::user()->role === 'admin' ? route('admin.surat-keluar.create') : route('opd.surat.create') }}" class="btn btn-dark-blue rounded-3 px-4 py-2 fw-medium">
                            Kirim Surat
                        </a>
                    @else
                        <a href="{{ route('login') }}" class="btn btn-dark-blue rounded-3 px-4 py-2 fw-medium">
                            Mulai Sekarang
                        </a>
                    @endauth
            ...
            <div class="col-lg-6 mt-5 mt-lg-0">
                <div class="hero-image-wrapper">
                    <img src="{{ asset('images/kominfo-building.jpg') }}" alt="Ilustrasi Persuratan" class="hero-image">
        ...
        <div class="row align-items-center">
            <div class="col-md-6 mb-4 mb-md-0">
                ...
                <p class="small mb-0 opacity-75">
                    &copy; {{ date('Y') }} Kementerian Komunikasi dan Informatika RI. Hak Cipta Dilindungi Undang-Undang.
                </p>
            </div>
            <div class="col-md-6">
